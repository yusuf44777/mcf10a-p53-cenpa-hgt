...
To characterize the nature of these prediction differences, we compared
logistic regression on 40-dimensional PCA features against logistic regression
trained on 64-dimensional HGT cell embeddings---an apples-to-apples comparison
isolating representation quality from classifier architecture.
