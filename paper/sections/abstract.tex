...
Critically, silhouette-score analysis of learned cell representations reveals that
HGT embeddings achieve a silhouette score of 0.782 for the six perturbation
conditions---40-fold higher than raw PCA coordinates (0.020)---demonstrating that
near-ceiling linear classification accuracy on strongly structured perturbation data
does not reflect equivalent representation quality.
...
with only 10\% of labeled training data, highlighting the large effect sizes that
dominate this perturbation design.
