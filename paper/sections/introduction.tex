...
Single-cell RNA sequencing (scRNA-seq) has transformed the study of cellular
heterogeneity by enabling transcriptional profiling at single-cell resolution,
making it possible to dissect perturbation responses that would be obscured by
bulk averaging \citep{wang2021scgnn}.
...
analysis.
The central finding is that while near-ceiling linear classification accuracy
obscures differences among supervised methods, HGT-derived embeddings achieve
silhouette scores 40-fold higher than raw PCA coordinates, providing
biologically interpretable representations that preserve both p53 and CENP-A
perturbation structure simultaneously.
